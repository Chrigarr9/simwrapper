...
export const panelLookup: { [key: string]: AsyncComponent } = {
  ...
  histogram: defineAsyncComponent(() => import('@/components/interactive/HistogramCard.vue')),
  line: defineAsyncComponent(() => import('./line.vue')),
  pie: defineAsyncComponent(() => import('./pie.vue')),
  'pie-chart': defineAsyncComponent(() => import('@/components/interactive/PieChartCard.vue')),
