...
@.planning/phases/02.1-dashboard-card-component/02.1-01-SUMMARY.md

# DashboardCard created in prior plan
@src/plugins/interactive-dashboard/components/DashboardCard.vue
@src/plugins/interactive-dashboard/types/dashboardCard.ts
...
<task type="auto">
  ...
  <files>src/plugins/interactive-dashboard/components/DashboardCard.vue, src/plugins/interactive-dashboard/types/dashboardCard.ts</files>
  <action>
