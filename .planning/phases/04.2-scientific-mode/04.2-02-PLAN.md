...
must_haves:
  truths:
    - "JSZip library is installed and available"
    - "Export utility functions exist for Plotly charts and deck.gl/MapLibre maps"
    - "Bulk ZIP export function generates downloadable archive"
    - "Export configuration types are defined"
  artifacts:
    - path: "package.json"
